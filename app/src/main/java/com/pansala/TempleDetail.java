...
public class TempleDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get add button
        addTemple = (Button) findViewById(R.id.addTempleButton);
    ...
    protected void onResume() {
        ...
        addTemple.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                long status = mydb.addTemple(templeID, userID);
                if(status > 0){
                    Toast.makeText(TempleDetail.this, "Temple Added Successfully", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(TempleDetail.this, "Temple Cannot Be Added", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
