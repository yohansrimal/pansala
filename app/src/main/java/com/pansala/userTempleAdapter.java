...
public class userTempleAdapter extends RecyclerView.Adapter<userTempleAdapter.HolderRecord>{
    ...
    //constructor
    public userTempleAdapter(Context context, ArrayList<NModelRecord> recordsList) {
    ...
    public void onBindViewHolder(@NonNull HolderRecord holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, TempleDetail.class);
